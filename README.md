...
```
cd existing_repo
git remote add origin https://gitlab.tomskasu.ru/trainee/back-intern/coffeemachine_duvanov.git
git branch -M main
...
- [ ] [Set up project integrations](https://gitlab.tomskasu.ru/trainee/back-intern/coffeemachine_duvanov/-/settings/integrations)
